...
//         vec3(0, 2, 1), vec3(1, 0, 1), vec3(-1, 0, 1), std::make_shared<DiffuseMaterial>(vec3(0.1, 0.7, 0.1)));
//     scene.addObject(triangle);

//     auto PointLight = std::make_shared<PointLight>(vec3(2.0, 5.0, 0.0), vec3(1.0, 1.0, 1.0), 12.0);
//     scene.addLight(PointLight);
//     scene.prepareLights();

//     // Render
//     PathTracer tracer(256, 256, 100, 3);
